...
export class BoardsController {
  ...
  async createBoardImage(
    ...
    const userId = req.user.id;
    return this.boardsService.createBoardImage(
      +boardId,
      createBoardImageDto,
      userId,
    );
  ...
  async updateBoardImage(
    ...
    const userId = req.user.id;
    return this.boardsService.updateBoardImage(
      +imageId,
      updateBoardImageDto,
      userId,
    );
  ...
  async createBoardReply(
    ...
    const userId = req.user.id;
    return this.boardsService.createBoardReply(
      +boardId,
      createBoardReplyDto,
      userId,
    );
  ...
  async updateBoardReply(
    ...
    const userId = req.user.id;
    return this.boardsService.updateBoardReply(
      +replyId,
      updateBoardReplyDto,
      userId,
    );
